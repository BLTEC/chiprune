...
OBJS = $(addprefix $(BUILD_DIR)/$(TARGET)/, \
    ...
    sdmmc.o sd.o sdmmc_driver.o sdram.o sprintf.o \
	di.o gfx.o tui.o timer.o)
...
CFLAGS = $(ARCH) -Os -flto -g -nostdlib -ffunction-sections -fdata-sections -std=gnu11  $(WARNINGS) $(CUSTOMDEFINES) -fno-inline
