...
// Scratch buffer used by sdram_init() to extract/patch DRAM timing params.
// Reuses the USB bulk-out buffer, which is unused this early in boot
// (before UMS actually starts transferring data).
#define SDRAM_PARAMS_ADDR         USB_EP_BULK_OUT_BUF_ADDR
